-- Broker identity is supplied by the authenticated MT5 terminal. These keys
-- belonged to the retired catalog-based authorization path and are no longer
-- used to approve Bridge connections.
UPDATE public.brokers
SET connection_config = connection_config - 'broker_hints' - 'server_patterns'
WHERE connection_config ? 'broker_hints'
   OR connection_config ? 'server_patterns';
