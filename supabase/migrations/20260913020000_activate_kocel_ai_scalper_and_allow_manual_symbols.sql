-- Ensure the existing Kocel AI Scalper record is active in production.
-- The unique slug preserves one stable system strategy record.
...
-- Create the record only when an older production database is missing it.
