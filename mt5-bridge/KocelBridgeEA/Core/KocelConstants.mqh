...
#define KOCEL_DEFAULT_API_BASE_URL "https://kocelforex1.vercel.app"
...
const int KOCEL_COMMAND_POLL_SECONDS = 2;
const int KOCEL_COMMAND_RESULT_RETRY_SECONDS = 5;
const int KOCEL_COMMAND_HISTORY_LIMIT = 200;
